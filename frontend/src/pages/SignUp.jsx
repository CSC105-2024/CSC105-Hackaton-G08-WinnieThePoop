...
//         {/* Welcome Message */}
//         <div className="flex flex-col justify-center items-center font-poppins text-barbie mt-2 sm:mt-2 md:mt-3 lg:mt-4 sm: text-xl md:text-2xl lg:text-[32px]
//         transition-all duration-200 ease-in-out transform">

//           <div className="font-black">Welcome to</div>
//           <div className="-mt-2 font-black">BaDDiEz Bratminton!</div>
//         </div>
...
//               <button
//                 type="submit"
//                 className="border-3 rounded-lg w-[140px] h-[35px] text-xs md:w-[150px] md:h-[40px] md:text-sm lg:w-[180px] lg:h-[40px] lg:text-base bg-mintsorbet font-poppins font-semibold  
...
//             <NavLink
//               to="/login"
//               className="text-barbie hover:underline">
//               Login
//             </NavLink>
//           </div>
//         </form>
